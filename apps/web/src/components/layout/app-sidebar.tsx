...
const navItems = [
  ...
  { title: "Boards", href: "/boards", icon: LayoutGrid },
  ...
  return (
    <Sidebar>
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {navItems.map((item) => {
                // Highlight a parent route on its sub-pages too (e.g. Boards
                // stays active on /boards/<slug>), while keeping "/" exact.
                const isActive =
                  pathname === item.href ||
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-moodboard"
          target="_blank"
