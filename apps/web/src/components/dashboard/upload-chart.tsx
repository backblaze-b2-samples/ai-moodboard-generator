  ...
  return (
    <Card>
      <CardHeader className="border-b border-border py-4 px-5">
        <CardTitle className="card-title">B2 Write Activity</CardTitle>
        <CardDescription className="text-xs">
          Objects written to Backblaze B2, last 7 days
        </CardDescription>
      ...
      <CardContent className="p-5">
        {error ? (
          ...
          <EmptyState
            ...
            description="Generate pins or upload files to see B2 write trends here."
          />
        ) : (
