...
from app.runtime import boards, files, generate, health, metrics, upload  # noqa: E402
...
#
# Env-var names follow Backblaze Standard #3 (B2_APPLICATION_KEY_ID /
# B2_APPLICATION_KEY / B2_BUCKET_NAME / B2_REGION). The S3 endpoint is
# derived from B2_REGION (settings.b2_endpoint), so the region is what we
# require here.
...
app = FastAPI(
    title="AI Moodboard Generator API",
    description="Generate-and-pin AI moodboards, stored durably on Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
