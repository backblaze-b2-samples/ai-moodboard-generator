...
| `OPENAI_API_KEY` | OpenAI key Genblaze uses to drive `gpt-image-1` (required for `/generate`) |
| `B2_PUBLIC_URL_BASE` | Optional — set to render pins via durable public URLs instead of presigned URLs |
